const en: { [key: string]: string } = {
  ...
  addBillingdetailsBtnText: 'Add Billing Details',
  continue: 'Continue',
  ...
  confirmMessage1: 'The order has been placed successfully ',
  ...
  signInText: 'Login to your account',
  googleSignInText: 'Sign in with Google',
  courseImgText: 'Courses',
  scholarshipImgText: 'Scholarship',
  jobsImgText: 'Jobs',
